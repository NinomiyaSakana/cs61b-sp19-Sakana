 ...
 * @author Josh Hug
 */
//creature 继承了Occupant，creature中有energy这个变量
public class Plip extends Creature {
    ...
    public Color color() {
        r = 99;
        b = 76;
        g = 96*(int)energy+63; //g是int格式，energy是double
        return color(r, g, b);
    }
    ...
    public Action chooseAction(Map<Direction, Occupant> neighbors) {
        ...
        // Rule 1:If no empty adjacent spaces, STAY.
        if (emptyNeighbors.size()==0){
            return new Action(Action.ActionType.STAY);
        } else if(energy>1){//Rule,HINT: randomEntry(emptyNeighbors)
